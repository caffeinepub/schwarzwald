  ...
  const faqSections = [
    ...
    },
    {
      ...
      questions: [
        ...
        { q: t("faq.q_checkin"), a: t("faq.a_checkin") },
        { q: t("faq.q_keys"), a: t("faq.a_keys") },
      ],
    },
    {
      title: t("faq.cancellation.title"),
      questions: [
        { q: t("faq.q_cancel"), a: t("faq.a_cancel") },
        { q: t("faq.q_deposit"), a: t("faq.a_deposit") },
        { q: t("faq.q_dates"), a: t("faq.a_dates") },
      ],
    },
    {
    ...
    {
      title: t("faq.included.title"),
      questions: [
        { q: t("faq.q_price"), a: t("faq.a_price") },
        { q: t("faq.q_cleaning"), a: t("faq.a_cleaning") },
        { q: t("faq.q_pets"), a: t("faq.a_pets") },
      ],
    },
  ];
